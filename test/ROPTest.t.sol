...
contract ROPTest is Test {
    function test_LogRender() external {
        ...
        ROPMetadataRenderer metadataRenderer = new ROPMetadataRenderer(addressArray);

        console2.log(metadataRenderer.renderMetadata());
    }
}
